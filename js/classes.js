...
class Enemy extends Entity {
    ...
    constructor(x, y) {
        super();
        this.sprite = 'https://github.com/SoCalChristina/arcade-game/blob/master/images/char-horn-girl.png?raw=true';           // Image path
...
class Player extends Entity {
    constructor() {
        ...
        this.sprite = 'https://github.com/SoCalChristina/arcade-game/blob/master/images/char-pink-girl.png?raw=true';    // Set sprite info
